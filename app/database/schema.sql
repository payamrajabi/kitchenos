...
CREATE TABLE IF NOT EXISTS meal_plan_entries (
  ...
  -- True when this row was generated by the LLM and hasn't been "accepted" by
  -- a user interaction yet. Flips to false on any edit (servings, drag, etc.).
  is_suggestion INTEGER NOT NULL DEFAULT 0,
  -- JSON array of alternative candidates for the "cycle suggestion" button.
  -- Shape: [{"recipe_title": "...", "label": "...", "notes": "...", "recipe_id": 123|null}]
  suggestion_pool TEXT,
  created_at TEXT NOT NULL DEFAULT (datetime('now')),
  updated_at TEXT NOT NULL DEFAULT (datetime('now'))
);
...
CREATE TABLE IF NOT EXISTS meal_plan_slot_dismissals (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
